...
<head>
    ...
    <link rel="stylesheet" href="../css/estilos_mejorados_registrar_venta.css"> <!-- Nuevo CSS moderno -->
...
<body>
    ...
    <h2 style="text-align:center;">BUSCAR PRODUCTO</h2>
    <h2 style="text-align:center;">Registrar Venta</h2>

    <form action="../backend/registrar_venta_backend.php" method="POST" onsubmit="return prepararDatos()">
